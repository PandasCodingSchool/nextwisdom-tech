      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="w-10 h-10 bg-[#0ea5e9] rounded-full flex items-center justify-center hover:bg-[#0284c7] transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/about" className="text-gray-300 hover:text-[#0ea5e9] transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-300 hover:text-[#0ea5e9] transition-colors">
                  Services
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-gray-300 hover:text-[#0ea5e9] transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="/privacy" className="text-gray-400 hover:text-[#0ea5e9] text-sm transition-colors">
              Privacy Policy
            </Link>
            <Link href="/terms" className="text-gray-400 hover:text-[#0ea5e9] text-sm transition-colors">
              Terms of Service
            </Link>
          </div>
        </div>
