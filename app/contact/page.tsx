        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Contact <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#1e3a8a]">Us</span>
            </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0ea5e9] focus:border-transparent transition-all duration-200"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#0ea5e9] to-[#1e3a8a] text-white px-8 py-4 rounded-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@nextwisdomtech.com</p>
                    <p className="text-gray-600">support@nextwisdomtech.com</p>
                  </div>
                </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-12 h-12 bg-[#0ea5e9] rounded-lg flex items-center justify-center hover:bg-[#0284c7] transition-colors">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
                    </svg>
                  </a>
                  <a href="#" className="w-12 h-12 bg-[#1e3a8a] rounded-lg flex items-center justify-center hover:bg-[#1e40af] transition-colors">
                    <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                while a complex web application could take 3-6 months. We provide detailed timelines during the planning phase.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                continues to perform optimally. This includes bug fixes, updates, and technical support.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-gray-600">
                ...
                We choose the best technology stack based on your specific requirements.
              </p>
            </div>

            <div className="bg-white p-8 rounded-2xl shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-4">How do you handle project communication?</h3>
              <p className="text-gray-600">
                We maintain regular communication through scheduled meetings, progress reports, and dedicated 
                project management tools. You&apos;ll always be updated on your project&apos;s status.
              </p>
            </div>
          </div>
        </div>
